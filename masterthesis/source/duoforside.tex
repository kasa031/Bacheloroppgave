...
\newcommand{\duo@page@i}{%
  \begin{titlepage}
    ...
    \includegraphics[width=6cm]{OSLOMET-logo.png}\par
...
\newcommand{\duo@uio@eng}{Oslo Metropolitan University}
%\newcommand{\duo@uio@bm}{Storbyuniversitetet}
%\newcommand{\duo@uio@nn}{Storbyuniversitetet}

\newcommand{\duo@fac@eng}{Faculty of Technology, Art and Design}
%\newcommand{\duo@fac@bm}{...}
%\newcommand{\duo@fac@nn}{...}
...
\def \duo@opt {}
\def \duo@printer {\csname duo@uio@\duo@lang \endcsname}
