...
add("Background and motivation", 2, [
    ...
    "The proposed explanation is the scepticism paradox. General caution toward strangers may coexist with heightened openness to messages that appear socially or institutionally legitimate. Phishing often imitates belonging, safety, authority, or opportunity rather than obvious foreign fraud. The thesis therefore investigates emotional, cognitive, and contextual factors that make individuals vulnerable to this form of social engineering in Norway, with primary data collection planned among adults in higher education.",
...
add("Beyond the weakest link", 2, [
    ...
    "Attackers do not primarily exploit ignorance. They exploit context: urgency, authority, social relevance, and emotional need (Parker & Flowerday, 2020; Tsai et al., 2021). A person may reject a crude lottery scam yet respond to a message impersonating a university IT desk during exam season. This thesis treats phishing as a human decision problem disguised as an email, not as a failure of intelligence or attention alone.",
...
add("Problem statement and research questions", 2, [
...
add("Scope and delimitations", 2, [
    ...
    "The study will not deploy live deceptive phishing against participants without explicit ethical approval. Scenario vignettes present hypothetical messages and measure intended behaviour rather than actual credential compromise. This design balances ecological validity with participant welfare and institutional ethics requirements.",
])
...
add("Structure of the Phase 1 submission and planned thesis", 2, [
    "This Phase 1 submission (ACIT5910) comprises the Introduction and Literature Review, following course requirements of 5,000–10,000 words with a clear problem statement, research questions, and a plan for research in Phase 2 (ACIT5920) and Phase 3 (ACIT5930). Subsequent phases will add methodology, results, discussion, and conclusions. Figure 1 (planned) will summarise the scepticism paradox as a conceptual model linking rising stranger-scepticism, loneliness, lure type, and protective factors.",
...
add("Planned research for Phase 2 and Phase 3", 2, [
...
add("Literature Review", 1, [])

add("Phishing and social engineering in cybersecurity research", 2, [
    ...
    "Human factors research shows that susceptibility correlates with persuasion strategies, workload, time pressure, and perceived sender legitimacy more strongly than with intelligence (Parker & Flowerday, 2020; Tsai et al., 2021; Bayl-Smith et al., 2024). Employees and students may articulate correct security rules yet still click when messages appear urgent or socially relevant. This knowledge-behaviour gap is central to the scepticism paradox.",
    ...
    "Attack chains frequently begin with a human action even when the ultimate goal is ransomware or data exfiltration. Analysing phishing therefore remains important even when technical teams focus on later-stage malware. Initial compromise often depends on a message that does not appear malicious at the moment of decision—a condition the scepticism paradox is designed to explain.",
])

add("Critique of the weakest-link narrative", 2, [
    ...
    "From a design perspective, the weakest-link narrative encourages additive training—more modules, more reminders—without changing the decision environment. High email volume, fragmented attention, and ambiguous sender identities are structural features that increase verification cost. The scepticism paradox reframes the problem: users are not uniformly weak; they are selectively vulnerable when lures align with legitimate needs and when verification is costly.",
])

add("Loneliness, belonging, and fraud susceptibility", 2, [
    ...
    "In Norway, student loneliness is documented at scale. SHoT 2022 reports that 29% of students often miss someone to be with; campus presence correlates with lower loneliness (SHoT Study, 2022). SSB (2025) finds elevated loneliness among young adults in quality-of-life surveys. Yet loneliness is rarely integrated into cybersecurity curricula or awareness campaigns, creating a research and practice gap this thesis addresses.",
...
add("The scepticism paradox in empirical perspective", 2, [
    ...
    "Training materials that show only crude stranger scams may inadvertently teach a mental model in which \"real\" phishing looks foreign or absurd. When institutional impersonation arrives with correct branding, domestic language, and plausible context, sceptical individuals may still hesitate to dismiss the message—especially under time pressure. The paradox therefore has direct implications for awareness design.",
])

add("Protection Motivation Theory and its limits", 2, [
...
add("Norwegian digital trust and threat landscape", 2, [
    "Norway combines high institutional trust with high digital dependence. NSM (2026) reports that phishing and social manipulation remain leading citizen-facing threats. Nkom documents persistent digital fraud patterns (Nkom, n.d.). Halcyon and industry reports note AI-assisted personalisation lowering the cost of credible lures (Halcyon, 2026; Trend Micro, 2026), though emotional leverage remains decisive: AI improves production; human needs determine uptake.",
...
add("Smishing, vishing, and channel expansion", 2, [
    ...
    "In Norway, fraud warnings increasingly cover multiple channels simultaneously (Finans Norge, 2026; NSM, 2026). The scepticism paradox applies across channels: stranger-framed SMS scams may be easier to reject than messages appearing to come from a parcel service, bank, or university administration. Channel expansion increases the number of contexts in which lure-specific vulnerability may appear.",
...
add("Knowledge-behaviour gap and decision moments", 2, [
...
add("Security awareness training: limitations and alternatives", 2, [
    "Standard awareness training often emphasises identifying suspicious indicators: poor grammar, foreign domains, unexpected attachments. These heuristics are less reliable when AI improves language quality and when attackers use compromised legitimate accounts or plausible subdomains (Halcyon, 2026; Trend Micro, 2026).",
...
add("Theoretical positioning and related frameworks", 2, [
    ...
    "Risk communication research distinguishes perceived risk from behavioural response—a gap familiar in health and environmental domains. Cybersecurity has imported similar ideas through human factors and usable security, yet institutional training often still equates awareness with protection. By foregrounding lure-specific scepticism and loneliness as measurable variables, this thesis makes the gap testable rather than anecdotal.",
...
add("Research gap and synthesis", 2, [
    ...
    "Figure 1 (to be developed in Phase 2) will present the combined conceptual model: stranger-scepticism and loneliness as parallel inputs; lure type and situational pressure as moderators; verification habits and non-punitive culture as protective outputs. This model is deliberately human-centred. It does not deny technical controls but positions them as one layer in a system where meaning, not only malware, drives initial compromise.",
])

add("Remote work, cognitive bias, and reporting culture", 2, [
...
add("Artificial intelligence and the production of credible lures", 2, [
...
add("Cognitive style and Norwegian empirical precedents", 2, [
...
add("Student welfare, loneliness policy, and cybersecurity silos", 2, [
    ...
    "Practical recommendations may therefore span departments: student welfare communications that mention fraud targeting lonely students; security teams that avoid shame-based messaging during high-stress periods such as exam weeks.",
])

add("Planned methodology overview (Phase 2 and 3)", 2, [
    ...
    "Ethics: SIKT notification or approval before collection; informed consent; pseudonymisation; no live deceptive phishing without explicit approval; special care for fraud victimisation and shame topics. Data stored on institution-approved encrypted platforms with access limited to researcher and supervisor.",
...
add("Expected implications and academic positioning", 2, [
    ...
    "If hypotheses are not supported, the thesis will still advance discussion by documenting null findings in a Norwegian higher-education sample—valuable given the dominance of weakest-link assumptions in practice. Negative results would suggest revising the paradox or refining operationalisations rather than abandoning human-centred analysis.",
])

add("Closing synthesis for Phase 1", 2, [
    ...
    "In sum, the weakest-link narrative asks the wrong question—who failed?—when the more productive question is under what lure-specific conditions do cautious people still respond unsafely, and which organisational practices make verification and reporting feasible? That reframing is the intellectual core of this master thesis and the practical reason Phase 1 matters beyond coursework requirements.",
...
out = Path("/workspace/masterthesis/ACIT5910_phase1_essay.html")
out.write_text(html)
abstract_words = len(" ".join(abstract.split()).split())
print(f"Body words: {word_count}")
print(f"Total approx (body + abstract): {word_count + abstract_words}")
print(f"Wrote {out}")
